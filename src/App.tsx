...
export default function App() {
  ...
  return <main>
    <header className="hero"><div className="eyebrow">[MVP5-Employment-007]</div><div className="hero-row"><div><h1>Econ<span>—</span>Engine</h1><p>Fixed seeded employment connects labor-derived production, firm revenue, wages, and persistent household wealth.</p></div><div className="system-note"><i />Deterministic · $500 closed circuit</div></div></header>
